...
import { Checkicon41 } from "../../icons/Checkicon41";
import "./style.css";
            ...
            <div className="frame-2">
              ...
              <div className="div-3">
                ...
                <div className="list">
                  ...
                  <div className="item">
                    <Checkicon18 className="check-icon" />
                    <div className="element-14">შიდა აზომვითი ნახაზი</div>
                  </div>
                  <div className="item">
                    <Checkicon18 className="check-icon" />
                  ...
                  <div className="item">
                    <Checkicon18 className="check-icon" />
                    <div className="element-15">ორთოფოტო</div>
                  </div>
                  <div className="item">
                    <Checkicon18 className="check-icon" />
                    <div className="element-15">სიტუაციური ნახაზი</div>
                  </div>
                  <div className="item">
                    <Checkicon18 className="check-icon" />
                    <div className="element-15">ფოტომონტაჟი</div>
                  </div>
                </div>
              </div>
            </div>
