            ...
            <div className="content-2">
              ...
              <div className="flex-container-wrapper">
                <div className="flex-container-2">
                  ...
                  <div className="span-wrapper">
                    <span className="text-wrapper-8">
                      შენობა აზომილია ადრეულ წლებში და არ შეესაბამება დღეისათვის
                      არსებულ სტანდარტს. (მაგ: ძველი წესით სველი წერტილების და
                      აივნის ფართობი არ შედიოდა შენობის შიდა ფართში);
                      <br />
                    </span>
                  </div>
                  <div className="text-2">
            ...
            <div className="header-3">
              <div className="block-title-wrapper">
                <p className="block-title-2">
                  რა არის მიწის ნაკვეთის საკადასტრო აგეგმვითი/აზომვითი ნახაზი და
                  რა შემთხვევებში არის აუცილებელი მისი მომზადება?
                </p>
              </div>
              <ChevronIconBg
